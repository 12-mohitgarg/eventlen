...
const Phonelogin = () => {
  ...
  return (
//     <div>
//         <div style={{ backgroundImage: `url(${bg4})` }} className="flex items-center justify-center min-h-screen bg-black bg-cover text-white">
//       <div className="w-full max-w-md bg-[#262626] p-6 rounded-2xl shadow-lg">
...
//             ←
//           </button>
//           Enter Mobile Number and OTP</div>
//         </div>
...
//         {/* Proceed Button */}
//         <button
//           className="w-full bg-white text-[#f5167e] rounded-3xl text-lg font-semibold py-3 mt-6 hover:bg-[#f5167e] transition duration-200"
...
<div>
  ...
  >
    <div className="w-full bg-[#262626] px-12 py-16 rounded-2xl shadow-lg max-w-2xl">
      <div className="mb-6">
        <div className="text-2xl font-bold mb-4">
...
/>
      ...
      <button
        className="w-full bg-white text-[#f5167e] rounded-[2rem] text-lg font-semibold py-3 mt-6 hover:bg-[#f5167e] transition duration-200 sm:text-sm md:text-base lg:text-lg"
        onClick={handleProceed}
      >
        Proceed
      </button>
